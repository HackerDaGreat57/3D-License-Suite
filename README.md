...
**That hellish concept is not what software was *meant to be*.** Software is not something that is manufactured, shipped, and put on a shelf for a customer to pick up. Software is not a service powered by tiny workers in your computer who need food and healthcare. **Software is a set of instructions your computer follows, and its result is useful to you.**
