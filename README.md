...
1. Anyone must be able to obtain the other hardware's CAD/design files without having to pay, provide details, be related to someone, or login to a service. It is OK if people have to pay to get physical versions.
2. The other hardware should continue working to its full potential for as long as it physically can under the present conditions. (The hardware should not be designed to fail.)
